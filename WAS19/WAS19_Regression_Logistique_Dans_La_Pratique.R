########################################################
#Code du WAS19: Régression Logistique dans la pratique
#Par: Natacha NJONGWA YEPNGA
#Vidéo Disponbible Sur LeCoinStat:https://www.youtube.com/watch?v=XOfyd7DuFbw&list=PLyh35eYRez8fPQY7ujGjWI4lusS4jxp2N&index=18 
########################################################
...
# Source: Les informations pour la démonstration proviennent du dépôt de machine learning de l'Université de Californie à Irvine (UCI). 
# http://archive.ics.uci.edu/ml/index.php
#Il s'agit plus précisément du jeu de données sur les maladies cardiaques.
#Vous pouvez accéder à ces données en visitant le site de l'UCI dédié au machine learning 
# et en cherchant le jeu de données en question: http://archive.ics.uci.edu/ml/datasets/Heart+Disease
# La base est disponible sur Kaggle en cliquant sur le lien suivant: https://www.kaggle.com/datasets/fedesoriano/heart-failure-prediction
